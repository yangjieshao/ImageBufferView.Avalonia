...
namespace ImageBufferView.Avalonia.Sample.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        {
            get => _ImageBuffer2;
            set => this.RaiseAndSetIfChanged(ref _ImageBuffer2, value);
        }
        private ArraySegment<byte>? _ImageBuffer2= Convert.FromBase64String(
        ...
        {
            get => _PixelBufferFormat;
            set => this.RaiseAndSetIfChanged(ref _PixelBufferFormat, value);
        }
        private PixelBufferFormat _PixelBufferFormat = PixelBufferFormat.Encoded;
